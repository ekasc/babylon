...
const Composer = memo(function Composer({
	...
	const onKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
		...
		if (!commandMatches.length && e.key === "ArrowUp") {
		...
		if (!commandMatches.length && e.key === "ArrowDown") {
